        ...
        <section className='startPageHero__base'>
            ...
            <div className='startPageHero__optionsContainer'>
                <div className='startPageHero__optionsHeadingContainer'>
                    <h1 className='h1 startPageHero__optionsHeading animate' data-animate-key="text-stagger" data-animate-delay="0">
                        We are more than just a <br />
                        <span className='text--primary textcontentshadow animate d2' data-title="web development agency" data-animate-key="text-stagger" data-animate-delay="0.1">web development agency</span>
                    </h1>
                ...
                <div className='startPageHero__optionsGridContainer'>
                    <div className='startPageHero__optionsGrid'>
                        <div className='startPageHero__optionsGridItem animate' data-animate-key="text-stagger" data-animate-delay="0">
                        ...
                        <div className='startPageHero__optionsGridItem animate' data-animate-key="text-stagger" data-animate-delay="0.1">
